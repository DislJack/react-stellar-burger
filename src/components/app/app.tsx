...
import { TZeroLocation } from '../../utils/prop-types';
import { useDispatch } from '../../services/hooks';

type TLocationState = {
  background: TLocationState;
  hash: string;
  pathname: string;
  search: string;
  state: {
    background: TZeroLocation;
  }
}
...
function Switcher() {
  ...
  const background: TLocationState = location.state && location.state.background;
  const history = useHistory();
